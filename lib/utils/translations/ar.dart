const Map<String, String> ar = {
  ...
  'please attach a first photo of exploration':
      'برجاء إرفاق صورة الإستكشاف الاولى',
  'please attach a second photo of exploration':
      'برجاء إرفاق صورة الإستكشاف الثانية',
  ...
  'Information about insect density measurement site':
      'معلومات عن موقع قياس الكثافة الحشرية',
  'Location': 'الموقع',
  ...
  'The problem is resolved at the site number':
      'تم حل المشكلة الموجودة فى الموقع رقم',
  ...
  'path number': 'رقم المسار ',
  'Performance evaluation': 'تقييم الأداء',
  'Number Of Teams': 'عدد الفرق',
  'Number Of Employees': 'عدد العمال',
  'Number Of Sector Supervisors': 'عدد المشرفين',
  'Number Of Control Specialist': 'عدد أخصائيين المكافحة ',
  'Number Of Driver': 'عدد السائقين',
  'Number Of ULV': 'عدد أجهزة ULV',
  'Number Of fog': 'عدد أجهزة الضباب',
  'Number Of pump': 'طرمبات',
  'Number Of liquid': 'عدد الأجهزة السائلة',
  'Vehicles': 'السيارات',
  'Cities': 'المدن',
  "add": "إضافة",
