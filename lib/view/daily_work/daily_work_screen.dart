...
import 'package:prepare/core/controller/daily_controller/daily_work_map_proprities_controller.dart';
                        ...
                        return GetBuilder<DailyWorkMapPropertiesController>(
                            ...
                            builder: (prop) {
                              return Stack(
                                ...
                                children: [
                                  GoogleMap(
                                    initialCameraPosition: prop.initialPosition,
                                    compassEnabled: true,
