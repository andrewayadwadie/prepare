...
class InsectWidget extends StatelessWidget {
  const InsectWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10),
      child: GetBuilder<AllInsectsController>(
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      controller.onTapSelected(
                                          ctx, controller.insects[index].id,index);
                                    },
                                    child: Padding(
